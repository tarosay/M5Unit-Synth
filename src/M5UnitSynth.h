...
public:
  void begin(HardwareSerial *serial, int baud = UNIT_SYNTH_BAUD, uint8_t RX = 16, uint8_t TX = 17);
  void begin(SoftwareSerial *serial, int baud = UNIT_SYNTH_BAUD, uint8_t RX = 22, uint8_t TX = 21);
